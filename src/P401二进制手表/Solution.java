...
//    //index 当前位数 0
//    //和
//    public void binary(String s,int num,int length,int index,int sum){
//        if(num == 0){
//            if(sum < 60){
//                if(sum < 10){
//                    ans.add(s+"0"+sum);
...
//            return;
//        }
//        for (int i = index; i <= length - num; i++) {
//            binary(s,num-1,length,i+1,(int)Math.pow(2,i) + sum);
//        }
//    }
//
//    public void minute(String hour , int num){
//        binary(hour,num,6,0,0);
//    }
//
//
//}
...
class Solution {
    ...
    public List<String> readBinaryWatch(int turnedOn) {
        ...
        return Arrays.asList(ans [turnedOn]);
    }
